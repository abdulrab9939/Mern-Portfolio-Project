...
const AdminPanel = () => {
  ...
  const [techknow, setTechknow] = useState({});


  const submitHandler = (e) => {
    e.preventDefault();
    dispatch(updateUser(name, email, password, skills, about,techknow));

    console.log(name, email, password, skills, about,techknow);
  };
