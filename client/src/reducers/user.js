...
export const updateReducer = createReducer(
  {},
  {
    ...
    ADD_TECKNOW_REQUEST: (state) => {
      state.loading = true;
    },
    ADD_TECKNOW_SUCCESS: (state, action) => {
      state.loading = false;
      state.message = action.payload;
    },
    ADD_TECKNOW_FAILURE: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    },

    ADD_ABOUT_REQUEST: (state) => {
      state.loading = true;
    },
    ADD_ABOUT_SUCCESS: (state, action) => {
      state.loading = false;
      state.message = action.payload;
    },
    ADD_ABOUT_FAILURE: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    },

    DELETE_TECKNOW_REQUEST: (state) => {
      state.loading = true;
    },
    DELETE_TECHKNOW_SUCCESS: (state, action) => {
      state.loading = false;
      state.message = action.payload;
    },
    DELETE_TECHKNOW_FAILURE: (state, action) => {
      state.loading = false;
      state.error = action.payload;
    },

    ADD_WORKEXPERIENCE_REQUEST: (state) => {
      state.loading = true;
    },
    ADD_WORKEXPERIENCE_SUCCESS: (state, action) => {
      state.loading = false;
      state.message = action.payload;
    },
    ADD_TIMELINE_FAILURE: (state, action) => {
